...
class Telefono extends Model {
	...
	#int- orden- Posición en la que aparece el número de telefono
	public $orden;

	static $tabla = 'telefonos';
	...
	*/
	public $definition = array(
		...
		'fields' => array(
			...
			'telefono' => array('type' => TYPE_STRING, 'value' => ''),
	...
	*/
	...
	/*
	Devuelve un array con los teléfonos de un usuario
	parametros:
	- $id - id del usuario
	- $orden orden en el que se filtrará la tabla, puede ser null
	return array();	
	*/
	public static function getTelefonosId($id,$order = null)
	{
		if ($order == null)
			return DB::getInstance()->executeQ("SELECT * FROM telefonos WHERE id_usuario = ".$id);
		else
			return DB::getInstance()->executeQ("SELECT * FROM telefonos WHERE id_usuario = ".$id.' ORDER BY '.$order);
	}
